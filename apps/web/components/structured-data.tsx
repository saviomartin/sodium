...
import { REPOSITORY_PRICE_USD } from "@/lib/plan";
import {
  absoluteUrl,
  PUBLISHER,
  SITE_DESCRIPTION,
 ...
 * them: search crawlers, link unfurlers, and the answer engines this product
 * exists to be legible to.
 *
 * Everything here restates something the page actually shows. The price comes
 * from `lib/plan`, the same constant the pricing section quotes; the questions
    ...
    "@graph": [
      ...
      },
      {
        ...
        offers: {
          ...
          price: String(REPOSITORY_PRICE_USD),
          priceCurrency: "USD",
