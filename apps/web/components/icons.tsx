...
export { BracketsCurlyIcon } from "@phosphor-icons/react/dist/ssr/BracketsCurly";
...
export { HandTapIcon } from "@phosphor-icons/react/dist/ssr/HandTap";
...
export { SignpostIcon } from "@phosphor-icons/react/dist/ssr/Signpost";
export { SparkleIcon } from "@phosphor-icons/react/dist/ssr/Sparkle";
export { StackIcon } from "@phosphor-icons/react/dist/ssr/Stack";
export { StethoscopeIcon } from "@phosphor-icons/react/dist/ssr/Stethoscope";
...
export { TreeStructureIcon } from "@phosphor-icons/react/dist/ssr/TreeStructure";
...
/** Google's four-color G mark, used only to identify its sign-in option. */
export function GoogleMarkIcon({
  className,
  ...props
}: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 18 18" className={className} {...props}>
      <path
        fill="#4285F4"
