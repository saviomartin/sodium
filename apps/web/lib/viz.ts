 ...
 * app's panel surface (#1e1e1e): every slot sits in the dark lightness band,
...
export const VIZ_SURFACE = "#1e1e1e";
...
export function seriesColor(index: number): string {
  return index < VIZ_SERIES.length ? VIZ_SERIES[index]! : VIZ_MUTED;
}
