...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      analysis_runs: {
        Row: {
          access_tier: Database["public"]["Enums"]["analysis_access_tier"]
          commit_id: string
          created_at: string
          error: Json | null
      ...
      repository_billing: {
        ...
        Relationships: [
          {
            foreignKeyName: "repository_billing_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "repository_billing_repository_id_fkey"
            columns: ["repository_id"]
            isOneToOne: true
            referencedRelation: "repositories"
            referencedColumns: ["id"]
      ...
      stripe_webhook_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "stripe_webhook_events_repository_id_fkey"
            columns: ["repository_id"]
            isOneToOne: false
            referencedRelation: "repositories"
            referencedColumns: ["id"]
      ...
      tool_contracts: {
        ...
        Relationships: [
          {
            foreignKeyName: "tool_contracts_latest_version_id_fkey"
    ...
    Functions: {
      apply_repository_billing_event: {
        Args: {
    ...
    Enums: {
      analysis_access_tier: "free" | "paid"
